...
public:
    ...
    void get_anc_dist(ContractionHierarchy &ch, ContractionIndex &tcl, NodeID v, uint16_t h_max, std::vector<CHNeighbor> &result);
    distance_t query_distance(ContractionHierarchy &ch, NodeID s, NodeID t);
    distance_t query_distance(ContractionHierarchy &ch, ContractionIndex &tcl, NodeID s, NodeID t);//, size_t &covered_pairs, size_t &trunc_anc, size_t &untrunc_anc);
    ...
    const CHNeighbor& find_shortcut(const ContractionHierarchy &ch, NodeID prev, NodeID current) const;
    ...
    void customise_shortcut_graph(ContractionHierarchy &ch, ContractionIndex &tcl, const std::vector<Edge> &edges) const;
    void customise_shortcut_graph(ContractionHierarchy &ch, std::vector<Edge> &edges);
    void customise_hub_labelling(const ContractionHierarchy &ch, ContractionIndex &tcl) const;
